...
const e = yield* find2(...(_.length ? _ : ['phantom','silverfish','witch','pillager','creeper','zombie','zombie_villager','skeleton','cave_spider','spider','ghast','magma_cube','slime','drowned']));
